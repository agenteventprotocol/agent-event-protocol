...
description: "This document defines the purpose, scope, layered architecture, and event envelope of the Agent Events Protocol (AEP: working title; all identifiers using the `AEP` / `dev.aep.` / `@aep/*` roots are placeholders frozen at the naming decision)."
---
