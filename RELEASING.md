...
The packages (`@agenteventprotocol/sdk`, `agenteventprotocol-sdk`) version independently under
...
4. Registry availability confirmed **[M]**: npm `@agenteventprotocol` scope, PyPI `agenteventprotocol-sdk`,
