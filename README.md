...
> `aep://` scheme, `@aep/*` / `aep-sdk` package names) are final; nothing is
...
| [typescript-sdk](https://github.com/agenteventprotocol/typescript-sdk) | `@aep/sdk`: emit/consume/control helpers (sender and target sides) over the generated types |
| [python-sdk](https://github.com/agenteventprotocol/python-sdk) | `aep-sdk` (PyPI): the same, for Python, sync and asyncio |
